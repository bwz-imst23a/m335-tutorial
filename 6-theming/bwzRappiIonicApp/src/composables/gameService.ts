...
const { addMove, clear, history } = useHistoryService()
const newBoard = () => [
  ['', '', ''],
  ['', '', ''],
  ['', '', ''],
...
export function useGameService() {
  ...
  const checkLine = (cell1: string, cell2: string, cell3: string) =>
    cell1 && cell2 === cell1 && cell3 === cell2
